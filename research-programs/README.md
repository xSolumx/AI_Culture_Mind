...
| [03 — Triality memory and Intertwiner SchurScans](03-triality-memory-and-intertwiner-scans/README.md) | Which equivariant bilinear recurrences have finite associative lifts? | Exact algebra and bounded eager benchmarks; matched task advantage remains open |
...
| [06 — Spin(9) Dirac--Clifford sensing](06-spin9-dirac-clifford-sensing/README.md) | What can three real spinors identify, and how does their exact design problem reduce? | Exact local design theorem; unrestricted global design remains open |
