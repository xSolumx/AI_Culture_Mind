...
| Hybrid Memory v1.4/v1.4.5, GDN2 gate-law work, and Spin-Dirac G15A through G15B | Programme 03 for addressing, erase/write, observability, and retrieval; Programme 06 for trained model comparisons; Programme 04 only for exact Spin/Clifford representation claims | G11/G12 establish bounded causal learning, G13 rejects long-range archive promotion, and G14 is a constructed mechanism screen. G15A-S separately passes signed 28-generator composition transfer under oracle edit timing. G15B and retained-checkpoint repairs do not promote a fresh model; G15B-T and G15B-E both fail their exact-SM75 constructed learning screens. G15B-D now implements the prospectively frozen coupled residual-delta successor and qualification harness, but exact clean-SM75 Phase 0 and all learning evidence remain pending. The completed single-seed G16 SM75 shootout gives official fused Mamba-2 the ordinary-compression win at every context (`1.48571` versus v1.4.5 `1.58335` BPRB at L4096); local GDN2 and OLMo lose and every arm fails learned recall. These remain bounded development results, not generic association success, model-family promotion, full triality, or scaling/efficiency. |
