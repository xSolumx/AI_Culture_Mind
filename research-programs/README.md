...
| Spin(3)-to-Spin(12) `2.A5` ladder, branching atlas, and order-864,000 Spin(8) triality closure | Programme 04 for finite-subgroup and spinor representation claims | Triality remains confined to Spin(8); its fixed `2.A5` closure is reducible `4+4`, and exact branching or closure does not imply model quality |
