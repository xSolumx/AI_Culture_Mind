...
| [03 — Learned structured memory and retrieval systems](03-structured-memory-and-retrieval/README.md) | Direct/delta memories, learned and hierarchical routing, large-slot state, gathered access, fused kernels, and content-addressed hybrid memory | Frozen memory-core results, bounded v1.4.5 causal-learning evidence, the G15A mechanism ladder, and a passed G15A-R composition-only shared-chart confirmation under oracle frame/edit controls; no generic association, universal update-law winner, or robust ordinary-text long-range recall |
...
| Hybrid Memory v1.4/v1.4.5, GDN2 gate-law work, and Spin-Dirac G15A through G15A-R | Programme 03 for addressing, erase/write, observability, and retrieval; Programme 06 for trained model comparisons; Programme 04 only for exact Spin/Clifford representation claims | G11/G12 establish bounded causal learning, G13 rejects long-range archive promotion, and G14 is a constructed mechanism screen. G15A supports supplied-coordinate shared vector/positive-Spin lift; G15A-L exposes cosine unobservability; G15A-F restores comparator separation but misses absolute precision. On clean SM75 commit `eca70f0`, all five G15A-R development recipes qualify; fixed-LR/random at 600 steps reaches 0.0155--0.0285, so decay is not proven necessary. Least-intervention selection chooses `G-decay/random`, whose fresh seeds 2251/2267/2273 pass every L64/L256/L1024 four-arm gate with `S` means `1.21e-7`--`1.89e-7`. This establishes composition-only shared-chart learning under a four-probe oracle frame and oracle edit timing, not generic association, language, or full triality. G15B address/query learning is next, retaining `I/C/S/S-broken` and the selected recipe |
