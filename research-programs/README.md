...
| [03 — Learned structured memory and retrieval systems](03-structured-memory-and-retrieval/README.md) | Direct/delta memories, learned and hierarchical routing, large-slot state, gathered access, fused kernels, and content-addressed hybrid memory | Frozen memory-core results, bounded v1.4.5 causal-learning evidence, the distinct G15A-L/F failures, G15A-R chart repair, and passed G15A-S signed-dictionary transfer to unseen frame banks/center words under oracle edit timing; no learned topology, generic association, universal update-law winner, or robust ordinary-text long-range recall |
...
| Hybrid Memory v1.4/v1.4.5, GDN2 gate-law work, and Spin-Dirac G15A through G15A-S | Programme 03 for addressing, erase/write, observability, and retrieval; Programme 06 for trained model comparisons; Programme 04 only for exact Spin/Clifford representation claims | G11/G12 establish bounded causal learning, G13 rejects long-range archive promotion, and G14 is a constructed mechanism screen. G15A supports supplied-coordinate shared vector/positive-Spin lift; G15A-L exposes cosine unobservability; G15A-F restores comparator separation but misses absolute precision; G15A-R repairs four-probe chart precision. On exact SM75 clean commit `4067926`, G15A-S fresh seeds 2281/2287/2293 pass signed 28-generator composition transfer to unseen rank-56 frame banks and global center words: `S` means `6.89e-7`--`1.18e-6` through L1024 and every comparator/broken-2x gate passes. This remains composition-only transfer under oracle edit timing, not learned topology, generic association/address/query learning, negative-spin/Clifford utility, language, full triality, or scaling/efficiency. G16 is a frozen qualified four-arm harness with no training metric; G15B association remains next |
