...
| Hybrid Memory v1.4/v1.4.5, GDN2 gate-law work, and Spin-Dirac G15A/G15A-L cohorts | Programme 03 for addressing, erase/write, observability, and retrieval; Programme 06 for trained model comparisons; Programme 04 only for exact Spin/Clifford representation claims | G11/G12 establish bounded causal learning, G13 rejects long-range archive promotion, and G14 is a constructed mechanism screen. G15A supports shared vector/positive-Spin lift on its designed supplied-coordinate task and rejects a fixed Clifford/negative-spin read contribution. G15A-L then fails autonomous learned-coordinate attribution on clean SM75 commit `0c49f64` in seeds 2153/2161/2179: only seed 2161 L64 passes the absolute `S` thresholds, no row passes the 0.05 comparator gate, and learned `S-broken` matches `S` after chart reparameterization. Full-frame multi-query raw-Frobenius observability is next; full three-carrier triality, generic association, natural text, and scaling remain unsupported |
