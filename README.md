...
| [Pure Exceptional Delta v1.3.2](SSM-Models/pure_f4_delta_ssm_v1_3/README.md) | Experimental | The 27D `G2 -> Spin(7) -> Spin(8) -> Spin(9) -> F4 -> E6(-26)` ladder is retained. Exact fused sparse E6 passes its SM75 cheap-action gate and beats its dead-action control in 2/3 text seeds; it remains slower than Mamba-2 and loses all three Mamba quality comparisons, so only the transport component is promoted |
