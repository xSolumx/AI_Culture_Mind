...
| Hybrid Memory v1.4/v1.4.5 | Active research workspace | Validated small hybrid causal learning and commissioned synthetic memory; G14 supports decoupled edits only on a constructed task. G15A supports supplied-coordinate shared vector/positive-Spin lift; G15A-L rejects cosine-map attribution; G15A-F restores full-frame comparator separation but misses absolute precision. G15A-R repairs precision, and G15A-S passes fresh-seed signed 28-generator transfer to unseen full-rank frame banks and global center words under oracle edit timing. G15B is now frozen as an attention-free, interleaved, shared-payload commissioned-controller gate with exact oracle ceilings and causal interventions; it has no quality result yet. In the completed one-seed G16 SM75 development shootout, official fused Mamba-2 wins every context and beats v1.4.5 by `0.09764` BPRB at L4096; local GDN2 and OLMo Hybrid lose, and all four fail learned recall. This is not learned topology, generic-association success, language-family promotion, full triality, or a scaling law. |
