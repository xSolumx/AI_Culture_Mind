...
| [Pure Exceptional Delta v1.3.2](SSM-Models/pure_f4_delta_ssm_v1_3/README.md) | Experimental | The 27D `G2 -> Spin(7) -> Spin(8) -> Spin(9) -> F4 -> E6(-26)` ladder is retained. Exact fused sparse E6 transport now passes its SM75 cheap-action gate, while the complete model still misses the separate Mamba-2 systems gate; the v1.3.2 natural-text quality cohort is tracked independently from the historical dense-action failure |
