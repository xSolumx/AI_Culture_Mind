...
| Pure Exceptional Delta v1.3.1 | Experimental | The 27D `G2 -> Spin(7) -> Spin(8) -> Spin(9) -> F4 -> E6(-26)` ladder and repaired memory law are implemented. F4/E6 learn aligned hidden actions, but official fused Mamba-2 wins every matched SM75 natural-text seed; dense exceptional transport is not promoted |
