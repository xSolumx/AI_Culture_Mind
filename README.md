...
learning result or geometry authorization exists; the frozen runner and its
pending status are tracked in the
[`Phase-1 ledger`](SSM-Models/hybrid_memory_v1_4/G15BD_PHASE1_RESULTS.md).
