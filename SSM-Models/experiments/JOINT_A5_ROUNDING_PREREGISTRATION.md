...
The result clears the claim gate only if `joint_exact` passes both gates in all
ten seeds without reducing any seed's class-11 dense floor by more than one
