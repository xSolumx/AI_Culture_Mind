...
**Date:** 2026-08-24
**Status:** repaired and mechanically validated research prototype; no trained
checkpoint and no model-quality or matched-speed result.
...
The next scientific gate is the prospectively frozen G4a MQAR campaign in
[`PREREGISTRATION.md`](PREREGISTRATION.md). It has not been run.
...
- Frozen G4a parameter counts are 107,552 for the candidate and 112,290 for
...
- No 600-update G4a cohort has run.
