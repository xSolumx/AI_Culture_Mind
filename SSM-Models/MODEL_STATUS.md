...
| [Pure Exceptional Delta v1.3.2](pure_f4_delta_ssm_v1_3/README.md) | Experimental Albert/exceptional model | Completed 27D ladder, controlled action learning, exact canonical primitive actions, and a fused sparse-event SM75 recurrence | [Sparse v1.3.2 transport](pure_f4_delta_ssm_v1_3/SM75_PRIMITIVE_TRANSPORT_RESULTS.md) is 2.40x faster than dense E6 and beats its same-parameter dead control in 2/3 text seeds. It remains 1.53x slower than fused Mamba-2 and loses all three quality seeds, so the transport component passes while the complete model does not |
