...
| [Pure Exceptional Delta v1.3.2](pure_f4_delta_ssm_v1_3/README.md) | Experimental Albert/exceptional model | Completed 27D ladder, controlled action learning, exact canonical primitive actions, and a fused sparse-event SM75 recurrence | [Dense v1.3.1 text transport failed](pure_f4_delta_ssm_v1_3/QUALITY_LEARNING_RESULTS.md). [Sparse v1.3.2 transport](pure_f4_delta_ssm_v1_3/SM75_PRIMITIVE_TRANSPORT_RESULTS.md) is 2.36x faster than dense E6 and passes the cheap-action gate, but remains 1.41x slower than fused Mamba-2 and is not a complete-model systems promotion |
