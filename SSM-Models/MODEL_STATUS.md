...
| [Pure Exceptional Delta v1.3.1](pure_f4_delta_ssm_v1_3/README.md) | Experimental Albert/exceptional model | Completed 27D ladder, controlled action-learning cohort, and matched exact-SM75 natural-text cohort | [F4/E6 actions learn](pure_f4_delta_ssm_v1_3/QUALITY_LEARNING_RESULTS.md) when the target requires their extra directions, but official fused Mamba-2 wins every natural-text seed and is about 3.63x faster than the strongest exceptional arm; dense per-token exceptional transport is not promoted |
