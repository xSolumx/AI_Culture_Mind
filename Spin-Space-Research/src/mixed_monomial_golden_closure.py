"""Exact infinite-order witnesses for the mixed monomial/golden closures.
...
of the three mixed closures is infinite.
...
def certificate() -> dict[str, object]:
    """Return the exact mixed-closure infinitude certificate."""
    ...
    payload: dict[str, object] = {
        "schema_version": 1,
        "experiment": "mixed monomial/golden Spin(8) closure infinitude",
        "field": "Q(sqrt(5))",
        ...
        "claim_scope": {
            ...
            "not_claimed": [
                "topological or Zariski density in SO(8)",
