...
| [Adjacent Endpoint Octet Reduction](UNRESTRICTED_ENDPOINT_OCTET_REDUCTION.md) | Exact reduction, complete coordinate-boundary theorem, and strict extended-core theorem | Eight-sector subgroup-chain reduction; complete first Schur block; scalar, quadratic, and cubic second-block theorems; ten-face determinant boundary and \([1/8,7/8]^5\) diagonal dominance proved; width-\(1/8\) collars open |
