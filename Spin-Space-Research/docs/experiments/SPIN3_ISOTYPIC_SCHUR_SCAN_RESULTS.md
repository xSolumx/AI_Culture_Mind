...
> **Later status (2026-08-11):** The real-type construction below now has
> canonical complex- and quaternionic-type companions in
> [the division-algebra Schur-scan result](DIVISION_SCHUR_SCAN_RESULTS.md).
> This dated Spin(3) report is preserved unchanged as the original frozen
> experiment; the later result does not add automatic representation
> decomposition or a model-quality claim.
