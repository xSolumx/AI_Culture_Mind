...
> **Later matched boundary.** This exact supplied-address result remains the
> slot-capacity authority. Subsequent same-router experiments show no ordinary
> overwrite-capacity advantage over direct slots; triality's supported gain is
> cross-view action/routing completion. See the
> [2026-08-10 synthesis](SPIN8_SPIN9_HIERARCHICAL_MEMORY_RESULTS.md).
