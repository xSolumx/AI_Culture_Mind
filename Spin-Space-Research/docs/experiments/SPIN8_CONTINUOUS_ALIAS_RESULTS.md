...
> **Later robustness boundary.** The cohort below remains valid. The
> 2026-08-10 hierarchical follow-on reports dense/block/hard retrieval under a
> common router and locates the hard router's adversarial corruption frontier;
> see
