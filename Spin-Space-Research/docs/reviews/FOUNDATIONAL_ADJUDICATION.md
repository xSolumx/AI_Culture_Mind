...
> **2026-08-10 status note.** Later hierarchical-routing and co-moving FLA
> results improve the bounded memory architecture, but do not overturn the
> infinite-precision/positive-margin obstruction adjudicated here. They are
> finite-budget empirical and systems results.
